...
from langchain_community.document_loaders import PyPDFLoader  # Changed from LlamaParse
    ...
    def load_documents(self, persist: bool = True) -> None:
        ...
        for file in tqdm(pdf_files, desc="Loading PDFs"):
            try:
                ...
                loader = PyPDFLoader(pdf_path)  # Using PyPDFLoader instead
        ...
        text_splitter = RecursiveCharacterTextSplitter(
            ...
            chunk_overlap=300,  # Overlap to maintain context across chunks
            length_function=len
        )
